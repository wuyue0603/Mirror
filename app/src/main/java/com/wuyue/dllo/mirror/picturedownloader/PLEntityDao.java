...
/** 
 * DAO for table "PLENTITY".
*/
public class PLEntityDao extends AbstractDao<PLEntity, Long> {

    public static final String TABLENAME = "PLENTITY";

    /**
     * Properties of entity PLEntity.<br/>
    ...
    */
    ...
    public PLEntityDao(DaoConfig config) {
        super(config);
    }
    
    public PLEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PLENTITY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PLENTITY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PLEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public PLEntity readEntity(Cursor cursor, int offset) {
        PLEntity entity = new PLEntity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PLEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PLEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(PLEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
